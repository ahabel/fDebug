...
<!--
   ...
   This code is based on XMLPrettyPrint.xsl from chrome://global/content/xml of the toolkit.jar   
   It has been modified to suite our need ;)
      ...
      <xsl:choose>
         <xsl:when test="/empty">
            <xul:vbox flex="1" align="center">
               <xul:spacer flex="1"/>
               <xul:label value="No source information available" disabled="true"/>
               <xul:spacer flex="1"/>
            </xul:vbox>
         </xsl:when>
         <xsl:otherwise>
            <xul:vbox flex="1" style="padding-left:10px;">
               <div id="viewsource">                  
                  <xsl:apply-templates/>
               </div>
            </xul:vbox>
